      ...
      {!session?.connected ? (
        ...
        <>
          ...
          <article className="panel live-risk-card early-exit-card">
            <div className="panel-heading"><div><div className="eyebrow">AUTOMATIC LIVE EXITS</div><h3>Take profit + stop loss</h3></div><ShieldCheck size={17} className="heading-icon" /></div>
            ...
            <div className="risk-note"><ShieldCheck size={15} /><span>It can take profit at the configured target, cash out when the executable bid beats the model, or trigger a stop-loss at the configured net drawdown. It requires repeated fresh observations and rechecks the live book. FAK exits can partially fill or fail when liquidity is thin.</span></div>
          </article>
